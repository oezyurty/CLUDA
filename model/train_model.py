...
def main(args):
    ...
    model = CL4UDATS(num_inputs=(1+args.use_mask)*dataset_src[0]['sequence'].shape[1], output_dim=output_dim, num_channels=[64,64,64,64,64], num_static=dataset_src[0]['static'].shape[0], 
