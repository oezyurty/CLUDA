...
def main(args):
    ...
    feature_extractor = VRNN(x_dim=dataset_test_src[0]['sequence'].shape[1], h_dim=64, z_dim=64, n_layers=saved_args.n_layers)
    ...
    for i_batch, sample_batched in enumerate(dataloader_test_trg):
        ...
        _, _, trg_feat = feature_extractor(sample_batched['sequence'].transpose(0,1))
    ...
    for i_batch, sample_batched in enumerate(dataloader_test_src):
        ...
        _, _, src_feat = feature_extractor(sample_batched['sequence'].transpose(0,1))
